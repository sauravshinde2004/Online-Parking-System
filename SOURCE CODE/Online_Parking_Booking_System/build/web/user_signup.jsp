                                    ...
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <form action="user_reg" method="post">
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Name :</label>
                                                <input type="text" class="form-control" name="username" placeholder="Enter Your Name" required="required">
                                            </div>
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>DOB :</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" placeholder="Enter Your Phone No" required="required">
                                            </div>
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Address :</label>
